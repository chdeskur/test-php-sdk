...
class DealCombinedMetricsResponse extends JsonSerializableType
{
    /**
     * @var string $date Date of the revenue metric.
     */
    #[JsonProperty('date')]
    public string $date;

    /**
     * @var string $method Method used to calculate the revenue metric. When 'product' then the revenue is from the product data, when 'financials' then the revenue is from the financials data.
     */
    #[JsonProperty('method')]
