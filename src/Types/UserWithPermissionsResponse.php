...
class UserWithPermissionsResponse extends JsonSerializableType
{
    /**
     * @var string $name
     */
    ...
    /**
     * @var ?array<string, ?array<PermissionModel>> $permissionsByGroup
     */
    #[JsonProperty('permissions_by_group'), ArrayType(['string' => new Union([PermissionModel::class], 'null')])]
     ...
     *   permissionsByGroup?: ?array<string, ?array<PermissionModel>>,
     * } $values
     */
    public function __construct(
        ...
        $this->permissionsByGroup = $values['permissionsByGroup'] ?? null;
    }
}
